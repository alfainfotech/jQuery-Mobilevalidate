						...
						if (! field_message) {
							...
							if (! field_message) {
								if (this_field.is('input[type="radio"]')) {
									field_message = opts.message['radio'].replace('FIELDNAME', message_label);
								}
								else {
									field_message = opts.message['checkbox'].replace('FIELDNAME', message_label);
								}
							}
					...
					if (field_validate != 'false' || (field_required || field_pattern || field_message)) {
						...
						if (! field_message) {
							...
							if (this_field.is('input')) {
								...
								if (opts.message[field_type]) {
									field_message = opts.message[field_type].replace('FIELDNAME', message_label);	
								}
								else {
									field_message = opts.message['input'].replace('FIELDNAME', message_label);
								}
								
							}
							else if (this_field.is('select')) {
								field_message = opts.message['select'].replace('FIELDNAME', message_label);
							}
