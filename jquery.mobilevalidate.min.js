...
c))});g||(g=a.is('input[type="radio"]')?b.messages.radio.replace("%FIELDNAME%",f):b.messages.checkbox.replace("%FIELDNAME%",f));a.jqmData("message",g)}c('input[name="'+e+'"]').bind(b.bind.select,function(){b.validate(h,a,b,1)?b.remove(a,b):b.add(a,b)})}}else{var d=a.jqmData("validate"),i=a.attr("required"),j=a.attr("pattern"),g=a.jqmData("message");if(!d||i||j||g)a.jqmData("validate","true"),a.attr("id"),e=a.attr("name"),f=b.label(this),c.map(b.fields,function(b,c){if(!a.jqmData("match")&&e.match(c)){if(!j&&
